 ...
 *************************************************
 * last modifiy:Virus.V 2017-5-11 00:37:56
 * fix1:Corrects the problem that post query string generates incorrect format.
 * fix2:Fixed the problem that the HTTP header array can't output correctly after the 30x Found redirect.
 **************************************************/
...
class Snoopy
{
    ...
    function _httprequest($url, $fp, $URI, $http_method, $content_type = "", $body = "")
    {
        ...
        if (!empty($this->rawheaders)) {
			//fixby:virusv,2017-5-11 00:35:14
    ...
    function _prepare_post_body($formvars, $formfiles)
    {
        ...
        switch ($this->_submit_type) {
            case "application/x-www-form-urlencoded":
				...
				//fixby:virusv,2017-5-11 23:56:14
